...
tags: operations, deployment, validation, troubleshooting
---
...
- [operations/202-DEPLOYMENT.md](/repos/victus-infra/docs/operations/202-DEPLOYMENT) -> production
  deployment through GitHub Actions and Ansible.
- [operations/203-SECURITY.md](/repos/victus-infra/docs/operations/203-SECURITY) -> secrets, permissions,
...
[operations/203-SECURITY.md](/repos/victus-infra/docs/operations/203-SECURITY).
...
[operations/204-TROUBLESHOOTING.md](/repos/victus-infra/docs/operations/204-TROUBLESHOOTING).
...
- [100-ARCHITECTURE.md](/repos/victus-infra/docs/100-ARCHITECTURE) -> system structure and runtime
  flow.
- [300-CONTRACTS.md](/repos/victus-infra/docs/300-CONTRACTS) -> stable interfaces and invariants.
