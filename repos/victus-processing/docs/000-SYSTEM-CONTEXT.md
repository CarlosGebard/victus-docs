...
- [Architecture](/repos/victus-processing/docs/100-ARCHITECTURE): system design, components, data architecture,
  quality attributes, decisions, and invariants.
- [Operations](/repos/victus-processing/docs/200-OPERATIONS): configuration, daily commands, validation,
  troubleshooting, and rollback notes.
- [Contracts](/repos/victus-processing/docs/300-CONTRACTS): storage paths, environment variables, data layout,
...
- [CLI operations](/repos/victus-processing/docs/operations/cli): command groups and common command flow.
- [PDF processing operations](/repos/victus-processing/docs/operations/pdf-processing): runtime details
