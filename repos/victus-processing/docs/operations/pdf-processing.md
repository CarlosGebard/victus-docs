...
tags: operations, pdf-processing, llm
---
...
- StructuredBlock rows in PostgreSQL preserve the
  [StructuredBlock Contract](/repos/victus-processing/docs/contracts/fundamental/scientific/structured-block).
...
[Data Layout Contract](/repos/victus-processing/docs/contracts/local/data-layout),
[Evidence extraction](/repos/victus-processing/docs/operations/pipeline/evidence-extraction),
[Testing pipeline](/repos/victus-processing/docs/operations/pipeline/testing-pipeline).
