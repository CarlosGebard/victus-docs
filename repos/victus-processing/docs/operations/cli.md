...
- [Metadata extraction](/repos/victus-processing/docs/operations/pipeline/metadata-extraction)
- [Bibliography export](/repos/victus-processing/docs/operations/pipeline/bibliography-export)
- [PDF intake](/repos/victus-processing/docs/operations/pipeline/pdf-intake)
- [PDF processing](/repos/victus-processing/docs/operations/pipeline/pdf-processing)
- [Evidence extraction](/repos/victus-processing/docs/operations/pipeline/evidence-extraction)
- [Testing pipeline](/repos/victus-processing/docs/operations/pipeline/testing-pipeline)
...
Related: [Operations](/repos/victus-processing/docs/200-OPERATIONS).
