...
tags: contracts, artifacts, audit
---
...
| `data/lake/paper_stage_state.jsonl` | Local state per paper and stage. |
...
| `data/registry/artifact_registry.jsonl` | Local artifact index. |
...
- [Data Layout](/repos/victus-processing/docs/contracts/local/data-layout)
- [Artifact Schemas](/repos/victus-processing/docs/contracts/local/artifact-schemas)
- [Stage Handoffs](/repos/victus-processing/docs/contracts/local/stage-handoffs)
- [PipelineRun](/repos/victus-processing/docs/contracts/fundamental/scientific/pipeline-run)
- [PipelineEvent](/repos/victus-processing/docs/contracts/fundamental/scientific/pipeline-event)
- [ArtifactManifest](/repos/victus-processing/docs/contracts/fundamental/scientific/artifact-manifest)
