...
|---|---|---|---|
| [Paper Processing State](/repos/victus-processing/docs/contracts/fundamental/scientific/paper-processing-state) | `victus.scientific.paper_processing_state@v1` | active | Current operational dashboard row per paper |
