...
tags: operations, runtime, local-execution
---
...
More CLI detail: [CLI operations](/repos/victus-processing/docs/operations/cli).

PDF-processing detail: [PDF processing operations](/repos/victus-processing/docs/operations/pdf-processing).
...
- [Contracts](/repos/victus-processing/docs/300-CONTRACTS)
- [CLI operations](/repos/victus-processing/docs/operations/cli)
- [Contract synchronization](/repos/victus-processing/docs/operations/contracts-sync)
- [PDF processing operations](/repos/victus-processing/docs/operations/pdf-processing)
- [Pipeline runbooks](operations/pipeline/)
- [Runbooks](operations/runbooks/)
- [PostgreSQL pipeline records](/repos/victus-processing/docs/operations/runbooks/postgres-pipeline-records)
- [Data layout migration](/repos/victus-processing/docs/operations/runbooks/data-layout-migration)
