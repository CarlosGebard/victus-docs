...
live under [Scientific Contracts](/docs/contracts/scientific/README).

## Contract Index

| Contract | Identifier | Status | Purpose |
|---|---|---|---|
| [Processing Papers](/docs/contracts/processing/papers) | `victus.processing.papers@v1` | draft | Operational paper registry table |
| [Pipeline Runs](/docs/contracts/processing/pipeline-runs) | `victus.processing.pipeline_runs@v1` | draft | Complete pipeline execution table |
| [Stage Runs](/docs/contracts/processing/stage-runs) | `victus.processing.stage_runs@v1` | draft | Per-stage execution and debugging table |
| [Processing Artifacts](/docs/contracts/processing/artifacts) | `victus.processing.artifacts@v1` | draft | External artifact registry table |
| [Processing Errors](/docs/contracts/processing/processing-errors) | `victus.processing.processing_errors@v1` | draft | Traceable pipeline error table |
