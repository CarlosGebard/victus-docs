...
tags: contracts, artifacts, governance
---
...
|---|---|---|---|---|
| Paper | Contract Artifact | active foundation | `victus-docs` | [Paper](/docs/contracts/scientific/paper) |
| StructuredBlock | Contract Artifact | active foundation | `victus-docs` | [StructuredBlock](/docs/contracts/scientific/structured-block) |
| ExperimentMap | Contract Artifact | draft | `victus-docs` | [ExperimentMap](/docs/contracts/scientific/experiment-map) |
| CanonicalEvidence | Contract Artifact | draft | `victus-docs` | [CanonicalEvidence](/docs/contracts/scientific/canonical-evidence) |
| Embedding | Contract Artifact | stable shared artifact | `victus-docs` | [RAG Contracts](/repos/victus-rag/docs/300-CONTRACTS) |
| Retrieval | Contract Artifact | stable shared artifact | `victus-docs` | [RAG Contracts](/repos/victus-rag/docs/300-CONTRACTS) |
...
|---|---|---|
| `victus-processing` | [Processing Contracts](/repos/victus-processing/docs/300-CONTRACTS) | processing artifacts, paths, identities, stage handoffs |
| `victus-processing` | [Processing Data Layout](/repos/victus-processing/docs/contracts/local/data-layout) | local runtime artifact layout and stage outputs |
| `victus-rag` | [RAG Contracts](/repos/victus-rag/docs/300-CONTRACTS) | embedded Parquet inputs, Qdrant payloads, retrieval results, BEIR/evaluation artifacts |
